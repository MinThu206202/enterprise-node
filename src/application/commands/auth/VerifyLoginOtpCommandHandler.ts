...
import { CheckLoginDeviceUseCase } from "../../../application/use-cases/auth/CheckLoginDeviceUseCase.js";
import type { ICommandHandler } from "../../bus/ICommand.js";
import type { VerifyLoginOtpCommand } from "./VerifyLoginOtpCommand.js";

const TRUST_DAYS = 30;

export class VerifyLoginOtpCommandHandler implements ICommandHandler<VerifyLoginOtpCommand, VerifyLoginOtpResult> {
  constructor(
  ...
  private async handle(input: VerifyLoginOtpInput): Promise<VerifyLoginOtpResult> {
  ...
  async execute(command: VerifyLoginOtpCommand): Promise<VerifyLoginOtpResult> {
