...
import type { ResetPasswordInput } from "../dto/ResetPasswordInput.js";
...
import type { ResetPasswordCommand } from "./ResetPasswordCommand.js";

export interface ResetPasswordResult {
  message: string;
}

export class ResetPasswordCommandHandler implements ICommandHandler<ResetPasswordCommand, ResetPasswordResult> {
  constructor(
  ...
  private async handle(input: ResetPasswordInput): Promise<ResetPasswordResult> {
